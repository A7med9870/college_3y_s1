...
6-
SELECT Projectname FROM Project2
WHERE Fulldaysworked > 150;

7-
SELECT Employeenumber FROM Projects2
WHERE Fulldaysworked < 400;
SELECT Distict Employeenumber FROM Projects2
WHERE Fulldaysworked < 400;

8-
SELECT * FROM Projects2 Order by Fulldayworked DESC;
...
insert into employee3 (Name,EmployeeNumber,dateofbirth,salary)
select DISTINCT Name,EmployeeNumber,dateofbirth,salary
FROM loaddata
```
