...
public class ReverseFilterStream extends FilterInputStream {

	ReverseFilterStream(InputStream in) { super(in); }
	...
	public int read(byte [] sample, int offset, int length) throws IOException
	{
		...
		{
			// Get the value at one end of the buffer
			// and place it at the other (reversing it)
		}
		return length;
	}
}
