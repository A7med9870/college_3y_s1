...
public class TileMap {
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (
                    ...
                    if (img != null) imagemap.put(ch, img);
                    else System.err.println(
                        "Failed to load image '" + folder + "/" + fileName + "'"
                    );
                }
            }
            ...
            if (trimmed.startsWith("#map")) {
                ...
                while ((line = in.readLine()) != null) {
                    ...
                    for (
                        int col = 0;
                        col < mapWidth && col < line.length();
                        col++
                    ) tmap[col][row] = new Tile(
                        line.charAt(col),
                        col * tileWidth,
                        row * tileHeight
                    );
            ...
            System.err.println(
                "Failed to read in tile map '" + path + "':" + e
            );
            return false;
        }
    ...
    public String toString() {
        ...
        for (int r = 0; r < mapHeight; r++) {
            for (int c = 0; c < mapWidth; c++) s.append(
                tmap[c][r].getCharacter()
            );
